...
class Dataset(_TorchDataset):
    ...
    def __init__(self, transform=None):
        ...
        self.dataset_dir = os.path.join(root, "eurosat")
        ...
        self.classnames = list(np.unique([idata['classname'] for idata in self.data]))

        # Prepare class templates
        self.templates = template
        print("EUROSAT Num of samples: " + str(len(self.data)), end="\n")
